<%-- 
    Document   : police_find_data
    Created on : May 10, 2016, 2:44:37 PM
    Author     : AJAY YADAV
--%>
...
<html>
    ...
    <body>
        ...
        <p align="left"><a href="policeHome.jsp">Back</a></p>
        <h2 style="color: #484095;">Find Data in Hotels</h2>
         <form method="get" action="police_find_data.jsp">
            
             <table> 
                
                <tr><td><h3 style="color: blueviolet;">Enter id(Addhar no, voter no)</h3></td><td></td><td><input type="text" name="t1"></td><td></td><td><input type="submit" value="Submit" name="s"></td></tr>
